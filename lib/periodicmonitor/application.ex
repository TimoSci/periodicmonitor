defmodule Periodicmonitor.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: Periodicmonitor.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    PeriodicmonitorWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
