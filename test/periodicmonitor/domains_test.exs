defmodule Periodicmonitor.DomainsTest do
  ...
  describe "upsert_domain/1 with expired unregistered domain" do
    test "stores expired domain with nil expires_at when not registered" do
      attrs = %{
        name: "gone.eth",
        label_hash: "0xabc",
