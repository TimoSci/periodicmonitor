...
config :periodicmonitor, Periodicmonitor.Repo,
  username: "postgres",
  password: "postgres",
  hostname: "localhost",
  database: "periodicmonitor_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :periodicmonitor, PeriodicmonitorWeb.Endpoint,
  ...
  secret_key_base: "vGhlp73jaf6GR0S0K4etoXT8blBkzg/Rs1UWSqx+QwC5MiTcN9VvGU6gIEZV8sqX",
  server: false

# In test we don't send emails
config :periodicmonitor, Periodicmonitor.Mailer, adapter: Swoosh.Adapters.Test
